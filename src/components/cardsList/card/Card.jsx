    ...
    return (
        <div className="card">
            <div className="card__preview preview">
                <img src="/src/assets/images/discussion-img_1.jpg" alt="Реализация намеченных плановых заданий" className="preview__img"/>
            </div>

            <div className="card__content content">
                <a className="content__title title" href="#card-url">
                    <h2>Реализация намеченных плановых заданий</h2>
                </a>

                <div className="content__info info">
                    <div className="info__date date">
                        <span className="date__text">опубликовано </span>
                        4 часа назад
                    </div>

                    <a href='#author-url' className="info__author author">
                        <img src="/src/assets/images/avatar.jpg" alt="Дмитрий Гришин" className="author__img" />
                        <span className="author__name">Дмитрий Гришин</span>
                    </a>
                </div>
            </div>
            ...
            <div className="card__controls controls">
                <div className="controls">
                    ...
                    <ul className="controls__list list">
                        ...
                        <li className="list__item list__item--close">
                            <button className="list__close">Закрыть</button>
                        </li>
                    </ul>
                </div>
                <div className="karma">
                    <button className='karma__up'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="10" viewBox="0 0 19 10" fill="none">
                            <path d="M9.5 0L0 10H19L9.5 0Z" fill="#D9D9D9"/>
                        </svg>
                    </button>
                    <span className='karma__count'>286</span>
                    <button className='karma__down'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="10" viewBox="0 0 19 10" fill="none">
